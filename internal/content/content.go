...
func featured() []*sitepb.Project {
	...
	return []*sitepb.Project{
		{Id: "gwc", Name: "GoWebComponents", Status: "v4.3.0", Glyph: "⟠",
			...
			Blurb: "A React-style UI framework in Go→WASM. Hooks, a fiber runtime, SSR/hydration, typed HTML. This site runs on it.",
		...
		{Id: "grpcbridge", Name: "GoGRPCBridge", Status: "v0.0.19", Glyph: "⇄",
